...
const Header = () => (
  <header
    className={tw(`${headerStyle} bg-center bg-cover`)}
    style={{ backgroundImage: `url('https://0x0.st/oFVj.jpg')` }}
  >
    <div className={tw(`max-w-4xl mx-auto py-16 px-14 sm:px-6 lg:px-8`)}>
      ...
      <div className={tw(`max-w-xl mx-auto`)}>
        <p className={tw(`mt-10 text-gray-500 text-center text-xl lg:text-3xl text-gray-200`)}>
          Take your preparation to next level.
        </p>
      </div>
    ...
    <div className={tw(`flex justify-center w-full`)}>
      <div className={tw(`mt-4 w-full`)}>
        {/* <p className={tw(`font-mono uppercase text-center font-medium text-sm text-gray-600`)}>ks get iThese folt</p>
