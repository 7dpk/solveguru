...
const Footer = () => (
  <footer className={tw(`bg-white border-t border-gray-400 pt-7`)}>
    <div className={tw(`w-full lg:w-1/2 lg:mt-0 py-7 px-5`)}>
      <div className={tw(`border border-gray-400 rounded py-5 px-4`)}>
        <h4 className={tw(`font-mono text-sm text-gray-500 mb-3`)}>Be the first to know updates.</h4>
    ...
    <div className={tw(`max-w-7xl mx-auto text-gray-400 px-8 lg:px-0 flex flex-wrap`)}>
      <div className={tw(`mb-14 flex items-center w-full`)}>
        ...
        <p className={tw(`text-4xl text-indigo-500 font-bold`)}>Solve Guru</p>
      </div>
